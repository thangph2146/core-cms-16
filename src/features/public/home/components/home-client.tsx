        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-sm sm:prose-base md:prose-lg lg:prose-xl text-foreground leading-relaxed dark:prose-invert">
            <p className="mb-4 sm:mb-6 text-sm sm:text-base md:text-lg">
              Hệ thống Quản lý Sinh viên của Trường Đại học Ngân hàng Thành phố
              Hồ Chí Minh được thiết kế để tạo cầu nối giữa phụ huynh, gia đình
              và nhà trường. Chúng tôi hiểu rằng sự tham gia tích cực của gia
              đình đóng vai trò quan trọng trong thành công học tập của sinh
              viên ngành ngân hàng và tài chính.
            </p>
            <p className="mb-4 sm:mb-6 text-sm sm:text-base md:text-lg">
              Thông qua nền tảng này, phụ huynh có thể theo dõi tiến độ học tập,
              điểm số, lịch học và lịch thi của sinh viên. Đồng thời, phụ huynh
              có thể trao đổi thông tin trực tiếp với giảng viên, cố vấn học tập
              và nhận thông báo quan trọng từ nhà trường.
            </p>
            ...
            <div className="flex-1">
              <div className="mb-8">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Chúng tôi cam kết mang đến trải nghiệm tốt nhất cho phụ huynh
                  và sinh viên.
                </p>
              </div>
                ...
                <div className="bg-card/60 backdrop-blur-sm rounded-2xl p-6 border border-border">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Thông tin cá nhân và dữ liệu học tập được mã hóa và bảo
                        vệ an toàn.
                      </p>
                    </div>
                  </div>
